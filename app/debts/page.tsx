...
const initialDebts = [
  { id: 1, name: 'Tunde', amount: 5000, direction: 'owed_to_me', due: '2026-06-01', status: 'pending' },
  { id: 2, name: 'Mama', amount: 10000, direction: 'i_owe', due: '2026-06-10', status: 'pending' },
  { id: 3, name: 'Seun', amount: 2000, direction: 'owed_to_me', due: '2026-05-30', status: 'pending' },
]
          ...
          {owedToMe.map((d, i) => (
            <div key={d.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '0.9rem', marginBottom: '0.9rem', borderBottom: i < owedToMe.length - 1 ? '1px solid #f0ebe1' : 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <div>
                  <p style={{ fontWeight: '500', fontSize: '0.875rem', color: '#1a1a1a' }}>{d.name}</p>
                  <p style={{ fontSize: '0.75rem', color: '#6b7280' }}>Due {d.due || 'no date'}</p>
                </div>
              </div>
